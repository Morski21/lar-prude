...
@section('title', 'Dados da Doação - Lar dos Idosos')
    ...
    <div class="donation-container">
        <div class="form-section">
            <div class="form-header">
                <h1 class="form-title">Dados da Doação</h1>
                <p class="form-subtitle">Escolha o tipo e valor da sua doação</p>
            </div>
            
            <!-- Debug: Verificar se step1_data existe -->
            @if(!isset($step1Data))
                <div class="alert alert-danger">
                    <strong>Erro:</strong> Dados da etapa 1 não encontrados. <a href="{{ route('donation') }}">Voltar ao início</a>
                </div>
            @endif
            ...
            <form action="{{ route('donation.step2.process') }}" method="POST">
                ...
                <div class="donation-type-section">
                    <h3 class="section-title">Tipo de Doação</h3>
                    <div class="donation-type-options">
                        <label class="donation-type-option">
                            ...
                            <div class="option-card">
                                ...
                                <p>Contribuição financeira para manutenção e melhorias</p>
                            </div>
                        </label>
                        ...
                        <label class="donation-type-option">
                            ...
                            <div class="option-card">
                                ...
                                <p>Alimentos não perecíveis e produtos de higiene</p>
                            </div>
                        </label>
                ...
                <div class="donation-value-section">
                    <h3 class="section-title">Valor da Doação</h3>
                    ...
                    <div class="non-monetary-info" id="non-monetary-info" style="display: none;">
                        <div class="info-card">
                            ...
                            <p>Após o envio do formulário, nossa equipe analisará sua doação e entrará em contato para confirmar a aceitação e agendar a entrega no Lar dos Idosos.</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="image-section">
            <div class="image-content">
                <h2 class="image-title">Cada Contribuição Conta</h2>
                <p class="image-subtitle">Seja qual for o valor ou tipo, sua doação nos ajuda a continuar nosso trabalho de cuidado e acolhimento</p>
            </div>
        </div>
    </div>
</main>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Mostrar/ocultar seções baseado no tipo de doação
    ...
    // Limpar seleção de botões quando digitar valor personalizado
